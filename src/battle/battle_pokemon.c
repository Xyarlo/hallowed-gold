...
u8 TypeEffectivenessTable[][3] = {
    ...
    { TYPE_FLYING, TYPE_DRAGON, TYPE_MUL_NOT_EFFECTIVE },
    ...
    { TYPE_POISON, TYPE_DARK, TYPE_MUL_NOT_EFFECTIVE },
...
#if FAIRY_TYPE_IMPLEMENTED == 1
    { TYPE_FAIRY, TYPE_NORMAL, TYPE_MUL_NOT_EFFECTIVE },
    { TYPE_FAIRY, TYPE_FIRE, TYPE_MUL_NOT_EFFECTIVE },
    { TYPE_FAIRY, TYPE_GRASS, TYPE_MUL_NOT_EFFECTIVE },
    ...
    { TYPE_ICE, TYPE_DRAGON, TYPE_MUL_NOT_EFFECTIVE },
    { TYPE_ICE, TYPE_STEEL, TYPE_MUL_NOT_EFFECTIVE },
    { TYPE_DRAGON, TYPE_NORMAL, TYPE_MUL_SUPER_EFFECTIVE },
